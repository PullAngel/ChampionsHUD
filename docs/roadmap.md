...
- **Verificación:** test de punta a punta con la pantalla real de las 6 tarjetas del equipo de Angel (coordenadas de su captura) — las 6 especies, habilidades, ítems y los 4 movimientos de cada una caen en el campo correcto. 80 tests en total.
